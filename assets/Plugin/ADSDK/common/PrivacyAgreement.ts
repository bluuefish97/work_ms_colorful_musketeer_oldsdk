...
export default class PrivacyAgreement {
    ...
    load() {
        console.log("XminigameSDK", "PrivacyAgreement load");
        ...
        let privacyAgreementResArr = [
            ...
            "https://tencentcnd.minigame.xplaymobile.com/Other/SDK/SDKImage4/PrivacyAgreement2/bg.png",
    ...
    show(callback) {
        ...
        console.log("XminigameSDK", "PrivacyAgreement show");
        ...
        btn.getComponent(WidgetComponent).bottom = 143;
    ...
    open() {
        console.log("XminigameSDK", "PrivacyAgreement open");
        ...
        switch (res) {
            ...
            case "qyw":
                ...
                break;
            case "mml":
                sf = this.privacyAgreementRes[15];
                break;
            default:
    ...
    hide() {
        ...
        if (activeBg) {
            console.log("XminigameSDK", "find PrivacyAgreement hide");
        ...
        if (getChildBg) {
            console.log("XminigameSDK", "child PrivacyAgreement hide");
    ...
    destroy() {
        this.showflag = false;
        if (find("sdkCanvas/node_PrivacyAgreement")) {
            console.log("XminigameSDK", "find PrivacyAgreement destroy");
            find("sdkCanvas/node_PrivacyAgreement").removeFromParent();
        }

        if (this.node_PrivacyAgreement) {
            console.log("XminigameSDK", "PrivacyAgreement destroy");
    ...
    exit() {
        console.log("XminigameSDK", "PrivacyAgreement exit");
